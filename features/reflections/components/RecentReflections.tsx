...
import { BadgeCheck, BadgeAlert, BadgeInfo } from 'lucide-react';
...
export default function RecentReflections({ userId }: { userId: string }) {
    ...
    if (reflections.length === 0) return (
        <div className="text-center p-6 text-slate-400 bg-white dark:bg-slate-900 rounded-[24px] border border-slate-100 dark:border-slate-800">
