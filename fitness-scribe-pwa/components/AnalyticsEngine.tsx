        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
                <div className="bg-white p-4 rounded-2xl border border-gray-100 shadow-sm flex flex-col justify-between">
                    <span className="text-xs text-gray-400 uppercase font-bold mb-2">Consistency</span>
                    <div className="flex items-end">
                        <span className="text-3xl font-bold text-gray-800">{summary.workoutConsistency}%</span>
                        {summary.workoutConsistency >= 70 ? (
                            <TrendingUp className="w-5 h-5 text-green-500 mb-1 ml-2" />
                        ) : (
                            <div className="text-xs text-orange-500 mb-1 ml-2 font-medium">Needs Work</div>
                        )}
                    </div>
                </div>

                <div className="bg-white p-4 rounded-2xl border border-gray-100 shadow-sm flex flex-col justify-between">
                    <span className="text-xs text-gray-400 uppercase font-bold mb-2">Sugar Free</span>
                    <div className="flex items-end">
                        <span className="text-3xl font-bold text-gray-800">{summary.sugarFreeDays}</span>
                        <span className="text-xs text-gray-400 mb-1 ml-1">/ 7 Days</span>
                    </div>
                </div>
            </div>
            ...
            <div className="bg-white p-6 rounded-3xl shadow-sm border border-gray-100">
                <div className="flex items-center mb-6 justify-between">
                    <div className="flex items-center">
                        ...
                        <div>
                            <h3 className="font-bold text-gray-800">Sugar vs. Workout</h3>
                            <p className="text-xs text-gray-400">Does sugar kill your streak?</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="h-56 w-full">
                    <ResponsiveContainer width="100%" height="100%">
                        <ComposedChart data={chartData}>
                            ...
                            <XAxis dataKey="day" axisLine={false} tickLine={false} tick={{ fontSize: 12, fill: '#aaa' }} dy={10} />
                            ...
                            />
                            {/* Consistency Bar */}
                            <Bar yAxisId="left" dataKey="workout" fill="#e0e7ff" radius={[4, 4, 0, 0]} barSize={20} name="Workout Done %" />
                            {/* Sugar Slips Line */}
                ...
                <div className="mt-4 flex items-center justify-center space-x-6 text-xs text-gray-500">
                    <div className="flex items-center"><div className="w-3 h-3 bg-indigo-100 rounded mr-2"></div>Workout</div>
            ...
            <div className="bg-orange-50 p-6 rounded-3xl border border-orange-100">
                <div className="flex items-start">
                    <div className="p-2 bg-white rounded-full text-orange-500 shadow-sm mr-3">
                        <Moon className="w-5 h-5" />
                    </div>
                    <div>
                        <h3 className="font-bold text-orange-900">Late Night Danger Zone</h3>
                        <p className="text-sm text-orange-800 mt-1 opacity-80">
            ...
            <div className="bg-white p-6 rounded-3xl shadow-sm border border-gray-100">
                <div className="flex items-center mb-6">
                    ...
                    <div>
                        <h3 className="font-bold text-gray-800">Hydration Impact</h3>
                        <p className="text-xs text-gray-400">Water (L) vs. Cravings Resisted</p>
                    </div>
                </div>
